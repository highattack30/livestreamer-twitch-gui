module.exports = {
	...
	deb32: {
		options: {
			...
			"after-install": "build/resources/package/debian/postinst",
			"before-remove": "build/resources/package/debian/prerm",
			"after-remove": "build/resources/package/debian/postrm",

			/*
			// does not work: lintian is complaining. may be a bug in fpm v1.6.0
			"deb-meta-file": [
				"build/resources/package/debian/copyright"
			],
			*/
